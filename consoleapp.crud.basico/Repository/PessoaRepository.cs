...
namespace consoleapp.crud.basico.Repository
{
    public class PessoaRepository : IPessoaRepository
    {
        ...
        {
            _connection = new SqlConnection("Data Source=localhost, 1522;Initial Catalog=geekjobs;Integrated Security=False;User ID=sa;Password=GeekJobsAula1;TrustServerCertificate=true");
            _connection.Open();
        }
